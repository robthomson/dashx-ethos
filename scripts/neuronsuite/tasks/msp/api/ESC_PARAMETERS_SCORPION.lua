...
local escMode = {neuronsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_heligov"), neuronsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_helistore"), neuronsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_vbargov"), neuronsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_extgov"), neuronsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_airplane"), neuronsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_boat"), neuronsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_quad")}
local rotation = {neuronsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_ccw"), neuronsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_cw")}
local becVoltage = {"5.1 V", "6.1 V", "7.3 V", "8.3 V", "Disabled"}
local teleProtocol = {neuronsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_standard"), neuronsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_vbar"), neuronsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_exbus"), neuronsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_unsolicited"), neuronsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_futsbus")}
local onOff = {neuronsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_on"), neuronsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_off")}
