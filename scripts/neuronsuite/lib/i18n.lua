...
local function loadLangFile(filepath)
  if neuronsuite.utils and neuronsuite.tasks and neuronsuite.tasks.logger then
    neuronsuite.utils.log("i18n: loading language file " .. filepath,"info")
  end
  local chunk = assert(neuronsuite.compiler.loadfile(filepath), "i18n: loadfile error")
...
function i18n.evict()
  if translations then
    if neuronsuite.utils and neuronsuite.tasks and neuronsuite.tasks.logger then
      neuronsuite.utils.log("i18n: evicting language file to save memory","info")
    end
    translations = nil
