...
local gyroFilterType = {[0]=neuronsuite.i18n.get("api.FILTER_CONFIG.tbl_none"), [1]=neuronsuite.i18n.get("api.FILTER_CONFIG.tbl_1st"), [2]=neuronsuite.i18n.get("api.FILTER_CONFIG.tbl_2nd")}
local rpmPreset = {neuronsuite.i18n.get("api.FILTER_CONFIG.tbl_custom"),neuronsuite.i18n.get("api.FILTER_CONFIG.tbl_low"), neuronsuite.i18n.get("api.FILTER_CONFIG.tbl_medium"), neuronsuite.i18n.get("api.FILTER_CONFIG.tbl_high")}
