...
return {
    ...
    {col = 1, row = 3, type = "text", source = "flightmode", title = "Flight Mode", titlepos = "bottom", bgcolor = colorMode.bgcolor, transform = "floor", textcolor = colorMode.textcolor, titlecolor = colorMode.titlecolor},
    ...
    {col = 2, row = 2, type = "text", subtype = "stats", stattype = "min", source = "voltage", title = "Min Voltage", titlepos = "bottom", bgcolor = colorMode.bgcolor, transform = "floor", textcolor = colorMode.textcolor, titlecolor = colorMode.titlecolor},
