...
function timer.wakeup()
    local prefs = neuronsuite.preferences.timer or {}
    ...
    if elapsed >= targetSeconds then
        if not triggered then
            ...
            elseif elapsedMode == 1 then
                neuronsuite.utils.playFileCommon("multibeep.wav")
            elseif elapsedMode == 2 then
                neuronsuite.utils.playFile("events", "alerts/elapsed.wav")
            elseif elapsedMode == 3 then
                neuronsuite.utils.playFile("status", "alerts/timer.wav")
