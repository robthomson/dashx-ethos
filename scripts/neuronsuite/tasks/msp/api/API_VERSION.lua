...
local MSP_API_SIMULATOR_RESPONSE = neuronsuite.utils.splitVersionStringToNumbers(neuronsuite.config.supportedMspApiVersion[neuronsuite.preferences.developer.apiversion])
...
local function read()
    local message = {
        ...
        processReply = function(self, buf)
            ...
            mspData = neuronsuite.tasks.msp.api.parseMSPData(buf, MSP_API_STRUCTURE_READ)
