...
local function openPage(pageIdx, title, script)
    ...
    local saved = neuronsuite.preferences.timer or {}
    ...
    neuronsuite.app.formLines[neuronsuite.app.formLineCnt] = form.addLine(i18n("app.modules.settings.timer_alerting"))
    neuronsuite.app.formFields[formFieldCount] = form.addBooleanField(
        neuronsuite.app.formLines[neuronsuite.app.formLineCnt], nil,
        function() return config.timeraudioenable or false end,
        function(newValue)
            config.timeraudioenable = newValue
            neuronsuite.app.formFields[idxChoice]:enable(newValue)
            neuronsuite.app.formFields[idxPre]:enable(newValue)
            neuronsuite.app.formFields[idxPost]:enable(newValue)
            neuronsuite.app.formFields[idxPrePeriod]:enable(newValue and (config.prealerton or false))
            neuronsuite.app.formFields[idxPreInterval]:enable(newValue and (config.prealerton or false))
            neuronsuite.app.formFields[idxPostPeriod]:enable(newValue and (config.postalerton or false))
            neuronsuite.app.formFields[idxPostInterval]:enable(newValue and (config.postalerton or false))
        end
    )
    ...
    formFieldCount = formFieldCount + 1
    neuronsuite.app.formLineCnt = neuronsuite.app.formLineCnt + 1
    neuronsuite.app.formLines[neuronsuite.app.formLineCnt] = form.addLine(i18n("app.modules.settings.timer_elapsed_alert_mode"))
    ...
    neuronsuite.app.formFields[formFieldCount] = form.addBooleanField(
        ...
        function(newValue)
            ...
            neuronsuite.app.formFields[idxPrePeriod]:enable(audioEnabled and newValue)
            neuronsuite.app.formFields[idxPreInterval]:enable(audioEnabled and newValue)
        end
    )
    ...
    neuronsuite.app.formFields[formFieldCount]:enable((config.timeraudioenable or false) and (config.prealerton or false))
    ...
    neuronsuite.app.formFields[formFieldCount] = form.addBooleanField(
        ...
        function(newValue)
            ...
            local audioEnabled = config.timeraudioenable or false
            neuronsuite.app.formFields[idxPostPeriod]:enable(audioEnabled and newValue)
            neuronsuite.app.formFields[idxPostInterval]:enable(audioEnabled and newValue)
        end
    )
    ...
    neuronsuite.app.formFields[formFieldCount]:enable((config.timeraudioenable or false) and (config.postalerton or false))
    ...
    neuronsuite.app.formFields[idxChoice]:enable(config.timeraudioenable or false)
    neuronsuite.app.formFields[idxPre]:enable(config.timeraudioenable or false)
    neuronsuite.app.formFields[idxPrePeriod]:enable((config.timeraudioenable or false) and (config.prealerton or false))
    neuronsuite.app.formFields[idxPreInterval]:enable((config.timeraudioenable or false) and (config.prealerton or false))
    neuronsuite.app.formFields[idxPost]:enable(config.timeraudioenable or false)
    neuronsuite.app.formFields[idxPostPeriod]:enable((config.timeraudioenable or false) and (config.postalerton or false))
    neuronsuite.app.formFields[idxPostInterval]:enable((config.timeraudioenable or false) and (config.postalerton or false))
    ...
    local buttons = {
        {
            ...
            action = function()
                ...
                for key, value in pairs(config) do
                    neuronsuite.preferences.timer[key] = value
                end
