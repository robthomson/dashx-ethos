...
function render.wakeup(box)
    -- Read current count
    local value = neuronsuite.ini.getvalue(neuronsuite.session.modelPreferences, "general", "flightcount")
    local displayValue

    -- Track last valid while connected
    local telemetryActive = neuronsuite.session and neuronsuite.session.isConnected
