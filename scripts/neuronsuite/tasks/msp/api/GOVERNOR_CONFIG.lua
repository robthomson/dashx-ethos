...
if neuronsuite.utils.apiVersionCompare(">=", "12.09") then
    ...
    local gov_modeTable ={[0] = neuronsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_govmode_off"), neuronsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_govmode_external"), neuronsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_govmode_electric"), neuronsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_govmode_nitro")}
    local throttleTypeTable ={[0] = neuronsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_throttle_type_normal"), neuronsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_throttle_type_off_on"),neuronsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_throttle_type_off_idle_on"),neuronsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_throttle_type_idle_auto_on")}
    ...
    local gov_modeTable ={[0] = neuronsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_govmode_off"), neuronsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_govmode_passthrough"), neuronsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_govmode_standard"), neuronsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_govmode_mode1"), neuronsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_govmode_mode2")}
