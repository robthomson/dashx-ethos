...
local function drawLogoImage(cx, cy, w, h)
  local imageName = "SCRIPTS:/" .. neuronsuite.config.baseDir .. "/widgets/dashboard/gfx/logo.png"
  local bmp = neuronsuite.utils.loadImage(imageName)
  if bmp then
...
local function renderOverlayText(dashboard, cx, cy, innerR, fg)
  local message = dashboard._overlay_text or neuronsuite.i18n.get("widgets.dashboard.loading")
