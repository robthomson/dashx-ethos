...
local modelPreferenceDefaults = {
    ...
    battery = {
        ...
        smartFuelSagCompensation = 70,
        smartFuelVoltageFallRate = 5,
        smartFuelDropRate = 1,
...
local function buildBatteryConfig(prefs)
    ...
    return {
        ...
        smartFuelSagCompensation = tonumber(battery.smartFuelSagCompensation) or 70,
        smartFuelVoltageFallRate = tonumber(battery.smartFuelVoltageFallRate) or 5,
        smartFuelDropRate = tonumber(battery.smartFuelDropRate) or 1,
...
local function normalizeWidgetSettings(widget)
    ...
    widget.smartFuelSagCompensation = clamp(math.floor(tonumber(widget.smartFuelSagCompensation) or 70), 0, 200)
    widget.smartFuelVoltageFallRate = clamp(math.floor(tonumber(widget.smartFuelVoltageFallRate) or 5), 1, 100)
    widget.smartFuelDropRate = clamp(math.floor(tonumber(widget.smartFuelDropRate) or 1), 1, 20)
...
function runtime.readWidgetSettings(widget)
    ...
    if widget then
        ...
        widget.smartFuelSagCompensation = tonumber(batteryPrefs.smartFuelSagCompensation) or 70
        widget.smartFuelVoltageFallRate = tonumber(batteryPrefs.smartFuelVoltageFallRate) or 5
        widget.smartFuelDropRate = tonumber(batteryPrefs.smartFuelDropRate) or 1
...
function runtime.writeWidgetSettings(widget)
    ...
    prefs.battery.smartFuelSagCompensation = widget.smartFuelSagCompensation
    prefs.battery.smartFuelVoltageFallRate = widget.smartFuelVoltageFallRate
    prefs.battery.smartFuelDropRate = widget.smartFuelDropRate
