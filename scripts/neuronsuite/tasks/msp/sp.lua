...
function transport.sportTelemetryPush(sensorId, frameId, dataId, value)
    return neuronsuite.tasks.msp.sensor:pushFrame({physId = sensorId, primId = frameId, appId = dataId, value = value})
end
...
function transport.sportTelemetryPop()
    local frame = neuronsuite.tasks.msp.sensor:popFrame()
...
transport.mspRead = function(cmd)
    return neuronsuite.tasks.msp.common.mspSendRequest(cmd, {})
end
...
transport.mspWrite = function(cmd, payload)
    return neuronsuite.tasks.msp.common.mspSendRequest(cmd, payload)
end
