...
function telemetryconfig.wakeup()
    ...
    if (neuronsuite.session.telemetryConfig == nil) and (mspCallMade == false) then
        mspCallMade = true
        ...
        API.setCompleteHandler(function(self, buf)
            ...
            neuronsuite.session.telemetryConfig = slots
            ...
            if neuronsuite.utils and neuronsuite.utils.log then
                neuronsuite.utils.log("Updated telemetry sensors: " .. slotsStr, "info")
            end
        end)
...
function telemetryconfig.reset()
    neuronsuite.session.telemetryConfig = nil
    mspCallMade = false
end

function telemetryconfig.isComplete()
    if neuronsuite.session.telemetryConfig ~= nil then
        return true
    end
end
