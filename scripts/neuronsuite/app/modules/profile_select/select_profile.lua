...
local function wakeup()
    ...
    if triggerSaveCounter == true then
        ...
        neuronsuite.app.dialogs.save:value(saveCounter)
        if saveCounter >= 100 then
            saveCounter = 0
            triggerSaveCounter = false
            neuronsuite.app.dialogs.saveDisplay = false
            neuronsuite.app.dialogs.save:close()
    ...
    if triggerMSPWrite == true then
        ...
        local profileIndex = neuronsuite.app.Page.fields[1].value
        local rateIndex = neuronsuite.app.Page.fields[2].value
