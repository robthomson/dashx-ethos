...
local MSP_API_STRUCTURE_READ = neuronsuite.tasks.msp.api.filterByApiVersion(MSP_API_STRUCTURE_READ_DATA)

-- calculate the min bytes value from the structure
local MSP_MIN_BYTES = neuronsuite.tasks.msp.api.calculateMinBytes(MSP_API_STRUCTURE_READ)

-- generate a simulatorResponse from the read structure
local MSP_API_SIMULATOR_RESPONSE = neuronsuite.tasks.msp.api.buildSimResponse(MSP_API_STRUCTURE_READ)
...
local function read()
    ...
    local message = {
        ...
        processReply = function(self, buf)
            ...
            neuronsuite.tasks.msp.api.parseMSPData(buf, structure, nil, nil, {
                chunked = true,
