...
local pages = {}
local sections = neuronsuite.compiler.loadfile("app/modules/sections.lua")()
...
if neuronsuite.app.moduleList == nil then neuronsuite.app.moduleList = neuronsuite.utils.findModules() end
...
for _, module in ipairs(neuronsuite.app.moduleList) do
    ...
    if sectionIndex then
        ...
        neuronsuite.utils.log("Warning: Section '" .. module.section .. "' not found for module '" .. module.title .. "'","debug")
    end
end
