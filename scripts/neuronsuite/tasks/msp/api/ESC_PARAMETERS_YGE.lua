...
local escMode = {neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_modefree"), neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_modeext"), neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_modeheli"), neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_modestore"), neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_modeglider"), neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_modeair"), neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_modef3a")}
local direction = {neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_normal"), neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_reverse")}
local cuttoff = {neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_off"), neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_slowdown"), neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_cutoff")}
local cuttoffVoltage = {"2.9 V", "3.0 V", "3.1 V", "3.2 V", "3.3 V", "3.4 V"}
local offOn = {neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_off"), neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_on")}
local startupResponse = {neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_normal"), neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_smooth")}
local throttleResponse = {neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_slow"), neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_medium"), neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_fast"), neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_custom")}
local motorTiming = {neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_autonorm"), neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_autoefficient"), neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_autopower"), neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_autoextreme"), "0°", "6°", "12°", "18°", "24°", "30°"}
local motorTimingToUI = {0, 4, 5, 6, 7, 8, 9, [16] = 0, [17] = 1, [18] = 2, [19] = 3}
local motorTimingFromUI = {0, 17, 18, 19, 1, 2, 3, 4, 5, 6}
local freewheel = {neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_off"), neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_auto"), neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_unused"), neuronsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_alwayson")}
