...
local flightMode = {neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_fmheli"), neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_fmfw")}
local motorDirection = {neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_cw"), neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_ccw")}
local becLvVoltage = {"6.0V", "7.4V","8.4V"}
local startupPower = {neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_low"), neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_medium"), neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_high")}
local fanControl = {neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_on"), neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_off")}
local ledColor = {neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_red"), neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_yellow"),neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_orange"),neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_green"),neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_jadegreen"),neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_blue"),neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_cyan"),neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_purple"),neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_pink"),neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_white")}
...
local lowVoltage = {neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_off"), "2.7V", "3.0V", "3.2V", "3.4V", "3.6V", "3.8V"}
local timing = {neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_auto"), neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_low"), neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_medium"), neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_high")}
local accel = {neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_fast"), neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_normal"), neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_slow"), neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_vslow")}
local brakeType = {neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_normal"), neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_reverse")}
local autoRestart = {neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_off"), "90s"}
local srFunc = {neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_on"), neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_off")}
local govMode = {neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_escgov"), neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_extgov") , neuronsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_fwgov")}
