...
-- 
-- This script initializes the logging configuration for the neuronsuite module.
-- 
...
-- "logs/neuronsuite_YYYY-MM-DD_HH-MM-SS.log".
-- 
-- The minimum print level for logging is set from `neuronsuite.preferences.developer.loglevel`.
-- 
...
os.mkdir("LOGS:/neuronsuite/logs")
logger.queue = assert(neuronsuite.compiler.loadfile("tasks/logger/lib/log.lua"))(config)
logger.queue.config.log_file = "LOGS:/neuronsuite/logs/neuronsuite_" .. os.date("%Y-%m-%d_%H-%M-%S") .. ".log"
logger.queue.config.min_print_level  = neuronsuite.preferences.developer.loglevel
local logtofile = neuronsuite.preferences.developer.logtofile
